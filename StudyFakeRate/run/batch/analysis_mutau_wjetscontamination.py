...
for sample in samples:
    ...
    batch[-1].name = "FakeRate_MuTau_WJetsContamination_"+sample[Name]
    batch[-1].exe = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/CMSSW/CMSSW_7_4_15/bin/slc6_amd64_gcc491/fakeratewjetscontamination.exe"
    ...
    batch[-1].tree = "tree"
    batch[-1].outputDirectory = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/MuTau_WJetsContamination/"+sample[Name]
    batch[-1].outputFile = "fakerates_MuTau_WJetsContamination_{0}.root".format(sample[Name])
    batch[-1].histoParameters = "../histos.par"
    batch[-1].histoTag = "HistosMuTauWJetsContamination"
