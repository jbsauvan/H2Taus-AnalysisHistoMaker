...
# Use only QCDSS fake factor for closure study in this QCD-enriched region
fakeFactorsTypes = ['QCDSS']
...
for sample in samples:
    ...
    batch[-1].tree = "tree"
    batch[-1].outputDirectory = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/MuTau/QCDFakeFactorClosure/{SAMPLE}".format(SAMPLE=sample[Name])
    ...
    # Muon cuts
    batch[-1].cuts.extend(["l1_reliso05>0.05", 'l1_reliso05<0.12',"l1_muonid_medium>0.5","l1_pt>19"])
    # Tau cuts
