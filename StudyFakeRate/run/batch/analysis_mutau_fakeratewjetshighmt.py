...
for sample in samples:
    ...
    batch[-1].tree = "tree"
    batch[-1].outputDirectory = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/76X/MuTau_FakeRateWJetsHighMT/"+sample[Name]
