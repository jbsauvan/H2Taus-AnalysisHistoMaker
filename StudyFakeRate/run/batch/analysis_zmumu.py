...
for sample in samples:
    ...
    batch[-1].name = "FakeRate_ZMuMu_{0}".format(sample[Name])
    batch[-1].exe = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/CMSSW/CMSSW_7_4_15/bin/slc6_amd64_gcc491/fakerate.exe"
    ...
    batch[-1].tree = "tree"
    batch[-1].outputDirectory = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/MuMu/{0}".format(sample[Name])
    batch[-1].outputFile = "fakerates_ZMuMu_{0}.root".format(sample[Name])
