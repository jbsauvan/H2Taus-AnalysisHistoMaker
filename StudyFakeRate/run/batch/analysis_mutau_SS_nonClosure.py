...
fakeFactorsTypes = ['HighMTSSRaw','HighMTSS']
...
for sample in samples:
    ...
    batch[-1].tree = "tree"
    batch[-1].outputDirectory = "/afs/cern.ch/work/j/jsauvan/Projects/Htautau_Run2/Histos/StudyFakeRate/MuTau/NonClosureSS/{SAMPLE}".format(SAMPLE=sample[Name])
