...
/*****************************************************************/
{
    ...
    inputChain->SetBranchStatus("tau1_againstElectronMVA6"                      , true);
    inputChain->SetBranchStatus("tau1_againstElectronMVA6category"              , true);
    inputChain->SetBranchStatus("tau1_againstElectronMVA6raw"                   , true);
    ...
    inputChain->SetBranchAddress("tau1_againstElectronMVA6"                      , &m_tau.againstElectronMVA6                     );
    inputChain->SetBranchAddress("tau1_againstElectronMVA6category"              , &m_tau.againstElectronMVA6category             );
    inputChain->SetBranchAddress("tau1_againstElectronMVA6raw"                   , &m_tau.againstElectronMVA6raw                  );
